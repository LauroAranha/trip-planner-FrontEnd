  ...
  return (
    <div className="map-container">
      ...
      <ul className="map-options">
        ...
        <li>
          <FontAwesomeIcon icon={faBirthdayCake} className="map-icon" />
          Parties
        </li>
        <li>
          <FontAwesomeIcon icon={faGlassCheers} className="map-icon" />
          Ballads
        </li>
        <li>
          <FontAwesomeIcon icon={faShoppingBag} className="map-icon" />
          Stores
        </li>
        <li>
          <FontAwesomeIcon icon={faShoppingBasket} className="map-icon" />
          Malls
        </li>
        <li>
